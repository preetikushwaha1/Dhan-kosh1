...
<body>
    ...
    <section id="main-content">
      <section class="wrapper">
         <h3><!--i class="fa fa-angle-right"--></i>Edit/Delete Account</h3>
        <div class="row mb">
          <!-- page start-->
                        ...
                        if($fetch_new_account_data->num_rows() > 0)
                        {
                          foreach($fetch_new_account_data->result() as $rows ) {?>
                              <tr>
                                ...
                                <td>
                                   <a href="<?php echo site_url('Main/view_account');?>" class="text-info fa fa-eye"  ></a><br>

                                    <a href="#" class="text-primary fa fa-pencil-square-o" onclick="return confirm('Are you sure you want to update this?')" ></a>

                                    <a href="<?php echo site_url('Main/delete_account/'. $rows->customer_id);?>" class="text-danger fa fa-trash-o" onclick="return confirm('Are you sure')" name="delete_account"></a>
                              </td>
                              </tr>
