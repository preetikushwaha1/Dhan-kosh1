        ...
        <div class="row mb">
          <!-- page start-->
            ...
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="get" name="edit_del_account_form">
                        ...
                        if($fetch_new_account_data->num_rows() > 0)
                        {
                          foreach($fetch_new_account_data->result() as $rows ) {?>
                              <tr>
                                ...
                                <td><a href="<?php echo site_url('Main/delete_account/'. $rows->customer_id);?>" class="btn btn-danger fa fa-trash-o" onclick="return confirm('Are you sure')" name="delete_account"></a></td>
                               </tr>
