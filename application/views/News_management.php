              ...
              <form class="form-horizontal style-form" method="post" action="<?php echo site_url('Main/news_management_form_validation');?>">
                ...
                <div class="form-group">
                  ...
                  <label class="col-sm-2 col-sm-2 control-label">News Detail</label>
                    <div class="col-sm-4">
                       <textarea class="form-control" name="news" id="news" placeholder="Your Message" rows="5" data-rule="required" data-msg="Please write something for us"></textarea>
                        ...
                        if($fetch_news->num_rows() > 0)
                        {
                          foreach($fetch_news->result() as $rows) { ?>
                            <tr>
                              ...
                              <td><a href="<?php echo site_url('Main/update_data/' . $rows->sr_no);?>" class="btn btn-primary fa fa-pencil" onclick="return confirm('Are you sure you want to update this?')" ></a></td>
