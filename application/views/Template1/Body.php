...
?>
    ...
    style="background-image: url('<?php echo base_url('assets1/images/hero_2.jpg');?>'" data-aos="fade" id="home-section">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
            ...
            <img src="<?php echo base_url('assets1/images/img_2.jpg');?>" alt="Free Website Template by Free-Template.co" class="img-fluid">
            </figure>
          </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-4 text-center" data-aos="fade-up" data-aos-delay="">
            <img src="<?php echo base_url('assets1/images/flaticon-svg/svg/001-wallet.svg');?>" alt="Free Website Template by Free-Template.co" class="img-fluid w-25 mb-4">
            <h3 class="card-title">Money Savings</h3>
            <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
          </div>
          <div class="col-md-4 text-center" data-aos="fade-up" data-aos-delay="100">
            <img src="<?php echo base_url('assets1/images/flaticon-svg/svg/004-cart.svg');?>" alt="Free Website Template by Free-Template.co" class="img-fluid w-25 mb-4">
            <h3 class="card-title">Online Shoppings</h3>
            <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
          </div>
          <div class="col-md-4 text-center" data-aos="fade-up" data-aos-delay="200">
            <img src="<?php echo base_url('assets1/images/flaticon-svg/svg/006-credit-card.svg');?>" alt="Free Website Template by Free-Template.co" class="img-fluid w-25 mb-4">
        ...
        <div class="row">
          <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
            <figure class="circle-bg">
            <img src="<?php echo base_url('assets1/images/about_2.jpg');?>" alt="Free Website Template by Free-Template.co" class="img-fluid">
            </figure>
          </div>
          <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
            <div class="mb-4">
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="">
            <div class="team-member">
              <figure>
                ...
                <img src="<?php //echo base_url('assets1/images/person_1.jpg');?>" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="team-member">
              <figure>
                ...
                <img src="<?php //echo base_url('assets1/images/person_2.jpg');?>" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
                <h3>Dave Simpson</h3>
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              <figure>
                ...
                <img src="<?php //echo base_url('assets1/images/person_3.jpg');?>" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
                <h3>Ben Thompson</h3>
                <span class="position">Bank Teller</span>
      ...
      <div class="container">
        ...
        <div id="posts" class="row no-gutter">
          <div class="item web col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
            <a href="<?php echo base_url('assets1/images/img_1.jpg');?>" class="item-wrap fancybox">
              <span class="icon-search2"></span>
              <img class="img-fluid" src="<?php echo base_url('assets1/images/img_1.jpg');?>">
            </a>
          </div>
          <div class="item web col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
            <a href="<?php echo base_url('assets1/images/img_2.jpg');?>" class="item-wrap fancybox" data-fancybox="gallery2">
              <span class="icon-search2"></span>
              <img class="img-fluid" src="<?php echo base_url('assets1/images/img_2.jpg');?>">
            </a>
          </div>

          <div class="item brand col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
            <a href="<?php echo base_url('assets1/images/img_3.jpg');?>" class="item-wrap fancybox" data-fancybox="gallery2">
              <span class="icon-search2"></span>
              <img class="img-fluid" src="<?php echo base_url('assets1/images/img_3.jpg');?>">
            </a>
          </div>

          <div class="item design col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">

            <a href="<?php echo base_url('assets1/images/img_4.jpg');?>" class="item-wrap fancybox" data-fancybox="gallery2">
              <span class="icon-search2"></span>
              <img class="img-fluid" src="<?php echo base_url('assets1/images/img_4.jpg');?>">
            </a>

          </div>

          <div class="item web col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
            <a href="<?php echo base_url('assets1/images/img_5.jpg');?>" class="item-wrap fancybox" data-fancybox="gallery2">
              <span class="icon-search2"></span>
              <img class="img-fluid" src="<?php echo base_url('assets1/images/img_5.jpg');?>">
            </a>
          </div>

          <div class="item brand col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
            <a href="<?php echo base_url('assets1/images/img_1.jpg');?>" class="item-wrap fancybox" data-fancybox="gallery2">
              <span class="icon-search2"></span>
              <img class="img-fluid" src="<?php echo base_url('assets1/images/img_1.jpg');?>">
            </a>
          </div>
        ...
        <div class="row align-items-lg-center" >
          <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
            ...
            <div class="owl-carousel slide-one-item-alt">
              <img src="<?php echo base_url('assets1/images/img_1.jpg');?>" alt="Image" class="img-fluid">
              <img src="<?php echo base_url('assets1/images/img_2.jpg');?>" alt="Image" class="img-fluid">
              <img src="<?php echo base_url('assets1/images/img_3.jpg');?>" alt="Image" class="img-fluid">
            </div>
      ...
      <div class="container">
        ...
        <div class="row align-items-stretch">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="unit-4">
              <div class="unit-4-icon">
                <img src="<?php echo base_url('assets1/images/flaticon-svg/svg/002-rich.svg');?>" alt="Free Website Template by Free-Template.co" class="img-fluid w-25 mb-4">
              </div>
              <div>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="">
            <div class="unit-4">
              <div class="unit-4-icon">
                <img src="<?php echo base_url('assets1/images/flaticon-svg/svg/003-notes.svg');?>" alt="Free Website Template by Free-Template.co" class="img-fluid w-25 mb-4">
              </div>
              <div>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="unit-4">
              <div class="unit-4-icon">
                <img src="<?php echo base_url('assets1/images/flaticon-svg/svg/005-megaphone.svg');?>" alt="Free Website Template by Free-Template.co" class="img-fluid w-25 mb-4">
              </div>
              <div>
      ...
      <div class="slide-one-item home-slider owl-carousel">
          <div>
            <div class="testimonial">
              ...
              <figure class="mb-4 d-flex align-items-center justify-content-center">
                <div><img src="<?php echo base_url('assets1/images/person_1.jpg');?>" alt="Image" class="w-50 img-fluid mb-3"></div>
                <p>John Smith</p>
              </figure>
            </div>
          </div>
          <div>
            <div class="testimonial">
              ...
              <figure class="mb-4 d-flex align-items-center justify-content-center">
                <div><img src="<?php //echo base_url('assets1/images/person_2.jpg');?>" alt="Image" class="w-50 img-fluid mb-3"></div>
          ...
          <div>
            <div class="testimonial">
              ...
              <figure class="mb-4 d-flex align-items-center justify-content-center">
                <div><img src="<?php //echo base_url('assets1/images/person_3.jpg');?>" alt="Image" class="w-50 img-fluid mb-3"></div>
                <p>Robert Spears</p>
              </figure>
    ...
    <section class="site-section" id="about-section">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
            <figure class="circle-bg">
            <img src="<?php echo base_url('assets1/images/img_4.jpg');?>" alt="Free Website Template by Free-Template.co" class="img-fluid">
            </figure>
          </div>
          <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="h-entry">
              <a href="single.html">
                <img src="<?php //echo base_url('assets1/images/img_4.jpg');?>" alt="Image" class="img-fluid">
              </a>
              <h2 class="font-size-regular"><a href="#">Banking is good for business? Why?</a></h2>
